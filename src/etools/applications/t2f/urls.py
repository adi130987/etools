...
from etools.applications.t2f.views.dashboard import TravelDashboardViewSet, ActionPointDashboardViewSet
...
from etools.applications.t2f.views.travel import (TravelActivityPerInterventionViewSet,
